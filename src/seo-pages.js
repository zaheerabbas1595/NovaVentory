...
export const commercialPages = {
  '/bracelets': {
    path: '/bracelets',
    title: 'Viking Bracelets & Nordic Bracelets | NovaVentory',
    description:
      'Shop NovaVentory Viking bracelets, Nordic bracelets, raven cuffs, dragon bangles, and stainless steel Norse wristwear on Etsy with free USA shipping.',
    eyebrow: 'Bracelet collection',
    heading: 'Viking Bracelets And Nordic Cuffs',
    intro:
      'Browse stainless steel Viking bracelets, black leather wraps, raven cuffs, dragon bangles, and Nordic-inspired wristwear from NovaVentory.',
    productNames: [
    ...
    sections: [
      {
        ...
        body: 'The bracelet collection focuses on rugged metal finishes, raven details, twisted cuff shapes, braided leather, and everyday pieces that carry a Viking-inspired look without feeling like costume jewelry.',
      },
      {
        title: 'Easy To Shop On Etsy',
  ...
  '/viking-bracelet': {
    ...
    title: 'Viking Bracelet For Men | Stainless Steel Norse Cuffs',
    description:
      'Shop Viking bracelet styles from NovaVentory, including twisted cuffs, raven bracelets, dragon cuffs, and black leather Norse bracelets on Etsy.',
    eyebrow: 'Viking bracelet edit',
    heading: 'Viking Bracelet Styles For Everyday Wear',
    intro:
      'Find Viking bracelet designs with stainless steel cuffs, raven motifs, braided leather, dragon details, and bold Norse character.',
    productNames: [
      'Viking Twisted Cuff Bracelet, 316L Stainless Steel Norse Bangle',
      'Viking Leather Bracelet, Braided Black Leather Chain',
      'Viking Raven Bracelet, Stainless Steel Norse Cuff Wristband',
    ...
    sections: [
      {
        ...
        body: 'Strong silhouettes, darkened metal, carved animal forms, braided leather, and old-world cuff shapes help these bracelets feel connected to Norse styling while staying practical for daily outfits.',
      },
      {
        title: 'Featured NovaVentory Viking Bracelets',
  ...
  '/nordic-bracelet': {
    ...
    eyebrow: 'Nordic bracelet collection',
    heading: 'Nordic Bracelet Designs With Norse Detail',
    intro:
      'Shop Nordic bracelet styles with raven symbols, twisted metal, stainless steel cuffs, and clean Norse-inspired finishes.',
    productNames: [
      'Viking Twisted Cuff Bracelet, 316L Stainless Steel Norse Bangle',
      'Norse Raven Cuff Bracelet, Stainless Steel Viking Bangle',
      'Viking Raven Bracelet, Stainless Steel Norse Cuff Wristband',
    ...
    sections: [
      {
        ...
        body: 'NovaVentory Nordic bracelets lean into raven shapes, sculpted cuff ends, stainless steel construction, and darker finishes that pair well with casual, streetwear, and layered jewelry looks.',
      },
      {
        title: 'Norse-Inspired Gift Options',
  ...
  '/raven-bracelet': {
    path: '/raven-bracelet',
    title: 'Raven Bracelet & Norse Raven Cuff | NovaVentory',
    description:
      'Shop raven bracelet styles from NovaVentory, including stainless steel Norse raven cuffs and Viking-inspired wristwear on Etsy.',
    eyebrow: 'Raven bracelet edit',
    heading: 'Raven Bracelet Styles Inspired By Norse Myth',
    intro:
      'Explore raven bracelets and Norse cuffs with dark finishes, stainless steel forms, and Viking-inspired details.',
    productNames: [
      'Norse Raven Cuff Bracelet, Stainless Steel Viking Bangle',
      'Viking Raven Bracelet, Stainless Steel Norse Cuff Wristband',
      'Viking Leather Bracelet, Braided Black Leather Chain',
    ...
    sections: [
      {
        ...
        body: 'Raven jewelry is a natural fit for Norse-inspired styling. These bracelet picks focus on strong wristwear with symbolic detail, textured metal, and a darker visual tone.',
      },
      {
        title: 'Shop Active Etsy Listings',
